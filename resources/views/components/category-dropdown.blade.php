        <x-dropdown1>
            ...
            <x-dropdown-item href="/laravel-from-scratch" :active="request()->routeIs('home')">All</x-dropdown-item>

            @foreach ($categories as $category)
                <x-dropdown-item href="/laravel-from-scratch/?category={{ $category->slug }}"
